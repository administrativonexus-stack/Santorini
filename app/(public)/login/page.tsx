    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center">
          <h1 className="font-heading text-4xl font-bold tracking-widest text-primary">SUA BARBEARIA</h1>
          <p className="mt-2 text-sm tracking-widest text-muted-foreground uppercase">Bem-vindo de volta</p>
        </div>
